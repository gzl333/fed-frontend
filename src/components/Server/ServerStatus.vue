<template>
  <span class="ServerStatus">
    ...
    <q-chip v-if="!props.server.status"
            ...
            clickable
            @click="isGroup ? $store.dispatch('vm/updateGroupServerTableSingleStatus', props.server.id) : $store.dispatch('vm/updateUserServerTableSingleStatus', props.server.id)">
