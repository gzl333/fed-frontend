        ...
        <div class="row">
          ...
          <div v-else class="col content-area">
            <div class="row items-center justify-center">
              <div class="col-auto">
                <div class="text-grey self-start">服务节点</div>
                <div>
                  <div>{{
              ...
              <div class="col-auto">
                ...
                >
                  ...
                  <div v-else>{{
                      quota.private_ip_total - quota.private_ip_used
                    }}/{{ quota.private_ip_total }}个
                  </div>
                </q-circular-progress>
              </div>
              ...
              <div class="col-auto">
                ...
                >
                  ...
                  <div v-else>{{
                      quota.public_ip_total - quota.public_ip_used
                    }}/{{ quota.public_ip_total }}个
                  </div>
                </q-circular-progress>
              </div>
              ...
              <div class="col-auto">
                ...
                >
                  ...
                  <div v-else>{{
                      quota.disk_size_total - quota.disk_size_used
                    }}/{{ quota.disk_size_total }}GB
                  </div>
                </q-circular-progress>
              </div>

              <div class="col-auto">
                {{ quota.expiration_time }}
              </div>
                    ...
                    >
                      ...
                      <q-td key="operation" :props="props" class="non-selectable">
                        <q-btn-group unelevated>
                          ...
                          <q-btn v-if="props.row.status=='运行中'" color="nord4" icon="power_settings_new"
                                 text-color="primary"
